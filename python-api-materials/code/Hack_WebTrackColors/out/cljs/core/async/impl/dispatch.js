...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_11709 = 0;while(true){
var m_11710 = cljs.core.async.impl.dispatch.tasks.pop();if((m_11710 == null))
{} else
{m_11710.call(null);
if((count_11709 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__11711 = (count_11709 + 1);
count_11709 = G__11711;
continue;
}
} else
{}
