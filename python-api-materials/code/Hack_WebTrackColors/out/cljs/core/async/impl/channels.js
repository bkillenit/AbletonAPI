...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t11715 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t11715 = (function (val,box,meta11716){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t11715.cljs$lang$type = true;
cljs.core.async.impl.channels.t11715.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t11715";
cljs.core.async.impl.channels.t11715.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"cljs.core.async.impl.channels/t11715");
});
cljs.core.async.impl.channels.t11715.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t11715.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11717){var self__ = this;
var _11717__$1 = this;return self__.meta11716;
});
cljs.core.async.impl.channels.t11715.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11717,meta11716__$1){var self__ = this;
var _11717__$1 = this;return (new cljs.core.async.impl.channels.t11715(self__.val,self__.box,meta11716__$1));
});
cljs.core.async.impl.channels.__GT_t11715 = (function __GT_t11715(val__$1,box__$1,meta11716){return (new cljs.core.async.impl.channels.t11715(val__$1,box__$1,meta11716));
});
}
return (new cljs.core.async.impl.channels.t11715(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_11718 = self__.takes.pop();if((taker_11718 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_11718))
{var take_cb_11719 = cljs.core.async.impl.protocols.commit.call(null,taker_11718);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_11719,taker_11718){
return (function (){return take_cb_11719.call(null,null);
});})(take_cb_11719,taker_11718))
);
} else
{}
{
