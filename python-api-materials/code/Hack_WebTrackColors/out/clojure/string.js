...
{{
var G__58560 = cljs.core.pop.call(null,v__$1);
v__$1 = G__58560;
continue;
}
} else
...
{var pred__58564 = cljs.core._EQ_;var expr__58565 = limit;if(cljs.core.truth_(pred__58564.call(null,1,expr__58565)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__58564.call(null,2,expr__58565)))
...
var G__58567 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__58568 = (limit__$1 - 1);
var G__58569 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__58567;
limit__$1 = G__58568;
parts = G__58569;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___58571 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___58571))
{var replacement_58572 = temp__4090__auto___58571;buffer.append([cljs.core.str(replacement_58572)].join(''));
} else
{buffer.append(ch);
}
{
var G__58573 = (index + 1);
index = G__58573;
continue;
}
}
